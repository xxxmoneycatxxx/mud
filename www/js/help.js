...
AdvancedMUDClient.prototype.getHelpTree = function () {
    if (!this._helpTree) {
        this._helpTree = [
            ...
            { cat: '门派介绍', topics: [['shaolin', '少林派介绍'], ['wudang', '武当派介绍'], ['emei', '峨嵋派介绍'], ['huashan', '华山派介绍'], ['gaibang', '丐帮之介绍'], ['taohua', '桃花岛介绍'], ['xingxiu', '星宿派介绍'], ['xiaoyao', '逍遥派介绍'], ['gumu', '古墓派介绍'], ['quanzhen', '全真派介绍'], ['xuanming', '玄冥谷介绍'], ['kunlun', '昆仑派介绍'], ['mingjiao', '明教之介绍'], ['riyue', '日月神教介绍'], ['lingjiu', '灵鹫宫介绍'], ['songshan', '嵩山派介绍'], ['dalunsi', '大轮寺介绍'], ['tiezhang', '铁掌帮介绍'], ['honghua', '红花会介绍'], ['xuedao', '血刀门介绍'], ['wudu', '五毒教介绍'], ['meizhuang', '梅庄之介绍'], ['zhenyuan', '镇远镖局介绍'], ['hengshan', '衡山派介绍'], ['jueqing', '绝情谷介绍']] },
