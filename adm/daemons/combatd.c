...
// 伤害消息数据驱动：每种伤害类型对应 6 级描述（从轻微到致命）
// 统一阈值：15 / 50 / 100 / 200 / 400
nosave mapping damage_msgs = ([
    // ---- 原有类型（文本与旧 switch-case 保持一致）----
    "擦伤" : ({
        "结果只是轻轻地划破$p的皮肉。\n",
        "结果在$p$l划出一道细长的血痕。\n",
    ...
    "刺伤" : ({
        "结果只是轻轻地刺破$p的皮肉。\n",
        "结果在$p$l刺出一个创口。\n",
        "结果「噗」地一声，$w已刺入了$n$l寸许！\n",
        "结果「噗」地一声，$w已刺进$n的$l，使$p不由自主地退了几步！\n",
    ...
    "反震伤" : ({
        "结果$N受到$n的内力反震，闷哼一声。\n",
        "结果$N被$n的反震得气血翻腾，大惊失色。\n",
        "结果$N被$n以内力反震，「嘿」地一声退了两步。\n",
        "结果$N被$n的内力反震，胸口有如受到一记重击，连退了五六步！\n",
        "结果$N被$n内力反震，眼前一黑，身子向後飞出丈许！\n",
        "结果$N被$n内力反震，眼前一黑，狂吐鲜血，身子象断了线的风筝向後飞去！\n",
    }),
    "砸伤" : ({
        "结果只是轻轻地碰到，像是给$n搔了一下痒。\n",
        "结果在$n的$l砸出一个小臌包。\n",
        "结果$N这一下砸个正着，$n的$l登时肿了一块老高！\n",
        "结果只听「砰」地一声，$n疼得连腰都弯了下来！\n",
        "结果重重地砸中，$n眼前一黑，「哇」地一声吐出一口鲜血！\n",
        "结果只听见「轰」地一声巨响，$n被砸得血肉模糊，惨不忍睹！\n",
    }),
    "枪伤" : ({
        HIC "结果子弹只是轻轻地擦过，并没有真正击中$n" HIC "。\n" NOR,
        HIC "结果子弹只是轻轻地擦过，并没有真正击中$n" HIC "。\n" NOR,
        HIR "结果$N" HIR "这一枪正中$n" HIR "的$l，直把$n" HIR "轰得血肉模糊！\n" NOR,
        HIR "结果$N" HIR "这一枪正中$n" HIR "的$l，直把$n" HIR "轰得血肉模糊！\n" NOR,
        HIR "结果$N" HIR "这一枪正中$n" HIR "的$l，直把$n" HIR "轰得血肉模糊！\n" NOR,
        HIR "结果$N" HIR "这一枪正中$n" HIR "的$l，轰出了一个碗口大的血洞！\n" NOR,
    }),
    // ---- 补齐漏洞：以下类型已被技能使用，但原 switch-case 未处理 ----
    "挫伤" : ({
        "结果只是轻轻地擦过$n的$l，留下一片淡淡的红印。\n",
        "结果在$n的$l砸出一块瘀青，$n微微皱眉。\n",
        "结果$N这一击正中$n的$l，$n闷哼一声，顿觉气血翻涌！\n",
        "结果$N重重一击，$n的$l登时肿起老高，痛彻入骨！\n",
        "结果「砰」地一声，$n被砸得连退数步，口中溢出一丝鲜血！\n",
        "结果只听见「砰」地一声闷响，$n被砸得骨断筋折，惨叫着飞了出去！\n",
    }),
    "抓伤" : ({
        "结果只是在$n的皮肉上留下了几道浅浅的指甲印。\n",
        "结果$n的$l被抓住，撕开几道细小的血痕。\n",
        "结果「嗤」地几声，$n的$l已被抓出数道血槽！\n",
        "结果$n痛哼一声，$l被抓得皮开肉绽，鲜血淋漓！\n",
        "结果$N一爪挥出，$n的$l顿时血肉模糊，深可见骨！\n",
        "结果只听见$n一声惨嚎，$l被抓得筋断骨裂，整块皮肉翻了起来！\n",
    }),
    "劈伤" : ({
        "结果只是轻轻地在$n的$l留下一道浅痕。\n",
        "结果在$n的$l劈出一道血口，$n微微变色。\n",
        "结果$N一刀劈下，$n的$l登时鲜血飞溅！\n",
        "结果「嗤」地一声，$n的$l被劈开一道深深的伤口，白骨隐约可见！\n",
        "结果$N奋力劈下，$n的$l应声而裂，鲜血如泉涌！\n",
        "结果只听见「喀」地一声，$n的$l被劈成两半，惨不忍睹！\n",
    }),
    "砍伤" : ({
        "结果只是轻轻地砍了$n一下，几乎没有造成伤害。\n",
        "结果在$n的$l砍出一道浅浅的刀痕。\n",
        "结果$N一刀砍去，$n的$l登时鲜血直流！\n",
        "结果「噗」地一声，$n的$l被砍出一道深可见肉的伤口！\n",
        "结果$N大力砍下，$n的$l几乎被砍断，鲜血狂喷！\n",
        "结果只听见$n一声惨嚎，$n的$l被一刀砍断，断肢飞了出去！\n",
    }),
    "拉伤" : ({
        "结果只是在$n的$l拉扯了一下，并无大碍。\n",
        "结果$n的$l被拉扯得有些疼痛，行动略受影响。\n",
        "结果$N猛地一拉，$n的$l传来一阵剧痛！\n",
        "结果$n的$l被拉得咯咯作响，筋腱似乎受了损伤！\n",
        "结果$N大力拉扯，$n的$l筋腱崩断数根，痛得$p大声惨叫！\n",
        "结果只听见「啪」地一声，$n的$l筋腱尽断，整条手臂无力地垂了下去！\n",
    }),
    "刮伤" : ({
        "结果只是轻轻地在$n皮肤上刮过，留下一道白印。\n",
        "结果$n的$l被刮去一层薄皮，微微渗出血珠。\n",
        "结果$N一扫而过，$n的$l被刮出一道长长的血痕！\n",
        "结果$n的$l被刮得皮肉翻卷，鲜血直流！\n",
        "结果$N猛烈刮过，$n的$l顿时血肉模糊，惨不忍睹！\n",
        "结果只听见$n一声惨叫，$l被刮得深可见骨，几乎体无完肤！\n",
    }),
    "摔伤" : ({
        "结果只是轻轻地摔了$n一下，并无大碍。\n",
        "结果$n被摔得晃了几晃，有些站立不稳。\n",
        "结果$N猛地一摔，$n重重跌在地上，痛得直咧嘴！\n",
        "结果$n被摔得七荤八素，「砰」地一声趴在地上！\n",
        "结果$N一记重摔，$n「喀」地一声，似乎摔断了几根骨头！\n",
        "结果只听见「砰」地一声巨响，$n被摔得骨断筋折，瘫在地上动弹不得！\n",
    }),
    "淤伤" : ({
        "结果只是轻轻地碰到，比拍苍蝇稍微重了点。\n",
        "结果在$p的$l造成一处淤青。\n",
...
// 统一阈值：6 级描述对应 5 个断点
nosave int *damage_thresholds = ({ 15, 50, 100, 200, 400 });
...
void killer_reward(object killer, object victim)
{
    ...
    if (playerp(victim))
    {
        ...
        if (objectp(killer) && killer->is_character())
        {
            ...
            if (mapp(actions) && !undefinedp(death_msgs[actions["damage_type"]]))
                msg += death_msgs[actions["damage_type"]];
            else
                msg += "杀死了";
        }
